...
const Addtodo=({bookdata,setbookdata,data,editid,index,setshow,show})=>{
      ...
      const updatedata=(newbook)=>{
          Editalldata(editid,newbook).then((data)=>{if(data){bookdata[index]=newbook
...
return(
  ...
  <div className="iform">
    ...
    {touched.birth && errors.birth? (
     ...
     <div className="div3">
    <button className="ubtn"  type="submit">Update</button></div>
    </form>
    </div>
</div>
)
